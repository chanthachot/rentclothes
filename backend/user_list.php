 <?php
  ...
  foreach ($users as $user) {
    ...
    if ($status == "user") {
      ...
      echo "<td>" . $phone .  "</td> ";
      //แก้ไขข้อมูล
      echo "<td><a href='user.php?act=edit&ID=$userid' class='btn btn-warning'>แก้ไข</a></td>";


      //ลบข้อมูล
      echo "<td><a href='user_form_del_db.php?ID=$userid' onclick=\"return confirm('คุณแน่ใจหรือว่าต้องการลบข้อมูลนี้ ?')\" class='btn btn-danger'>ลบ</a></td>";
      echo "</tr>";
    }
  }
  echo "</table>";
