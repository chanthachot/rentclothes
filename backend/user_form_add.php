      ...
      <form name="admin" action="user_form_add_db.php" method="POST" id="admin" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5" align="left">
            <input name="user_user" type="text" required class="form-control" id="user_user" pattern="^[a-zA-Z0-9]+$" title="ภาษาอังกฤษหรือตัวเลขเท่านั้น" minlength="2" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5" align="left">
            <input name="user_pass" type="password" required class="form-control" id="user_pass" pattern="^[a-zA-Z0-9]+$" minlength="2" />
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5" align="left">
            <input name="user_phone" type="text" required class="form-control" id="user_phone" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-3" align="right">อีเมล์</div>
          <div class="col-sm-5" align="left">
            <input name="user_email" type="text" required class="form-control" id="user_email" />
          </div>
        </div>
